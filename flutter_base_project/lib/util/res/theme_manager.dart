...
import 'package:inspection_app/util/res/responsive/dimen.dart';
import 'package:inspection_app/util/res/font_manager.dart';
import 'package:inspection_app/util/res/style_manager.dart';
...
class LightModeTheme implements MainThemeApp {
  ...
  ThemeData themeData = ThemeData(
    primaryColor: ColorName.greenPrimary,
    ...
    // Tắt hiệu ứng màu khi nhấn (splash/highlight/hover) cho mọi widget có onTap
    ...
    appBarTheme: AppBarTheme(
      ...
      iconTheme: const IconThemeData(
        color: ColorName.colorFontPrimaryLight,
        size: AppSize.s20,
      ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: const OutlineInputBorder(
        borderSide: BorderSide(
          color: ColorName.colorPrimaryLight,
          width: AppSize.s1_5,
        ),
        borderRadius: BorderRadius.all(Radius.circular(AppSize.s10)),
      ),
